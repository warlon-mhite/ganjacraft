...
public class WeedOnFireBreaksBottomProcedure extends GanjacraftModElements.ModElement {
	public WeedOnFireBreaksBottomProcedure(GanjacraftModElements instance) {
		super(instance, 93);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				GanjacraftMod.LOGGER.warn("Failed to load dependency x for procedure WeedOnFireBreaksBottom!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				GanjacraftMod.LOGGER.warn("Failed to load dependency y for procedure WeedOnFireBreaksBottom!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				GanjacraftMod.LOGGER.warn("Failed to load dependency z for procedure WeedOnFireBreaksBottom!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				GanjacraftMod.LOGGER.warn("Failed to load dependency world for procedure WeedOnFireBreaksBottom!");
			return;
		}
