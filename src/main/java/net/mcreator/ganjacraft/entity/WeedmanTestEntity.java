...
package net.mcreator.ganjacraft.entity;
...
public class WeedmanTestEntity extends GanjacraftModElements.ModElement {
	...
	public static class CustomEntity extends VillagerEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(6,
					new TemptGoal(this, 1, Ingredient.fromItems(new ItemStack(IndicaBudItem.block, (int) (1)).getItem()), false));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(SpliffItem.block, (int) (1)));
		}
