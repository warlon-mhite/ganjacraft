...
public class Weedcrop6topBlock extends GanjacraftModElements.ModElement {
	@ObjectHolder("ganjacraft:weedcrop6top")
	public static final Block block = null;
	@ObjectHolder("ganjacraft:weedcrop6top")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public Weedcrop6topBlock(GanjacraftModElements instance) {
		super(instance, 93);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("weedcrop6top"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("weedcrop6top");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Weedcrop stage 6 top");
		}
