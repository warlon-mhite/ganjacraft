...
public class HempPlanksWoddyStuffFenceBlock extends GanjacraftModElements.ModElement {
	@ObjectHolder("ganjacraft:hemp_planks_woddy_stuff_fence")
	public static final Block block = null;
	public HempPlanksWoddyStuffFenceBlock(GanjacraftModElements instance) {
		super(instance, 36);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("hemp_planks_woddy_stuff_fence");
		}
