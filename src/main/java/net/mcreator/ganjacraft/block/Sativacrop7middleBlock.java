...
public class Sativacrop7middleBlock extends GanjacraftModElements.ModElement {
	@ObjectHolder("ganjacraft:sativacrop_7middle")
	public static final Block block = null;
	@ObjectHolder("ganjacraft:sativacrop_7middle")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public Sativacrop7middleBlock(GanjacraftModElements instance) {
		super(instance, 186);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("sativacrop_7middle"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sativacrop_7middle");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("sativacrop_7middle");
		}
