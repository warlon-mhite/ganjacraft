...
public class Weedcrop3Block extends GanjacraftModElements.ModElement {
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("weedcrop3"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("weedcrop3");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Weed crop stage 3");
		}
