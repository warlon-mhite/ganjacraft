...
public class HempBaleBlock extends GanjacraftModElements.ModElement {
	@ObjectHolder("ganjacraft:hempbale")
	public static final Block block = null;
	public HempBaleBlock(GanjacraftModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.LEAVES).sound(SoundType.CROP).hardnessAndResistance(1f, 4f).setLightLevel(s -> 0));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("hempbale");
		}
