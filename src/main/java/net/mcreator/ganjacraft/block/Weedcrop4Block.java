...
public class Weedcrop4Block extends GanjacraftModElements.ModElement {
	@ObjectHolder("ganjacraft:weedcrop4")
	public static final Block block = null;
	@ObjectHolder("ganjacraft:weedcrop4")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public Weedcrop4Block(GanjacraftModElements instance) {
		super(instance, 71);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("weedcrop4"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("weedcrop4");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Weedcrop stage 4");
		}
