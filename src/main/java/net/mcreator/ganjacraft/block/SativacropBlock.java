...
public class SativacropBlock extends GanjacraftModElements.ModElement {
	@ObjectHolder("ganjacraft:sativacrop")
	public static final Block block = null;
	@ObjectHolder("ganjacraft:sativacrop")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SativacropBlock(GanjacraftModElements instance) {
		super(instance, 170);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("sativacrop"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 6, 16)).withOffset(offset.x, offset.y, offset.z);
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("sativacrop");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Sativa stage 0");
		}
