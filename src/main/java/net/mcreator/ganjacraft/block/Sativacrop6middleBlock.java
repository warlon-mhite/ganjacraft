...
import net.mcreator.ganjacraft.procedures.BreakUpAndDownBlockCropProcedure;
...
public class Sativacrop6middleBlock extends GanjacraftModElements.ModElement {
	@ObjectHolder("ganjacraft:sativacrop_6middle")
	public static final Block block = null;
	@ObjectHolder("ganjacraft:sativacrop_6middle")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public Sativacrop6middleBlock(GanjacraftModElements instance) {
		super(instance, 183);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("sativacrop_6middle"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.TALL_PLANTS).sound(SoundType.PLANT).hardnessAndResistance(0f, 0f).setLightLevel(s -> 0)
					.doesNotBlockMovement().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("sativacrop_6middle");
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				BreakUpAndDownBlockCropProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("sativacrop_6middle");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Sativa stage 4");
		}
