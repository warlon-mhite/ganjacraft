...
public class Weedcrop6Block extends GanjacraftModElements.ModElement {
	@ObjectHolder("ganjacraft:weedcrop6")
	public static final Block block = null;
	@ObjectHolder("ganjacraft:weedcrop6")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public Weedcrop6Block(GanjacraftModElements instance) {
		super(instance, 74);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("weedcrop6"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("weedcrop6");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Weedcrop stage 6 bottom");
		}
