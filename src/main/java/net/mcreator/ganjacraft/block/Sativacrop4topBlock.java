...
public class Sativacrop4topBlock extends GanjacraftModElements.ModElement {
	@ObjectHolder("ganjacraft:sativacrop_4top")
	public static final Block block = null;
	@ObjectHolder("ganjacraft:sativacrop_4top")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public Sativacrop4topBlock(GanjacraftModElements instance) {
		super(instance, 179);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("sativacrop_4top"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sativacrop_4top");
		}
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				BreakUnderBlockCropProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("sativacrop_4top");
		}
