...
import net.mcreator.ganjacraft.procedures.BreakUpperBlockCropProcedure;
...
public class Sativacrop5Block extends GanjacraftModElements.ModElement {
	@ObjectHolder("ganjacraft:sativacrop_5")
	public static final Block block = null;
	@ObjectHolder("ganjacraft:sativacrop_5")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public Sativacrop5Block(GanjacraftModElements instance) {
		super(instance, 180);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("sativacrop_5"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				BreakUpperBlockCropProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("sativacrop_5");
		}
