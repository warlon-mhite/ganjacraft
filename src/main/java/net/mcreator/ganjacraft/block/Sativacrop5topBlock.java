...
public class Sativacrop5topBlock extends GanjacraftModElements.ModElement {
	@ObjectHolder("ganjacraft:sativacrop_5top")
	public static final Block block = null;
	@ObjectHolder("ganjacraft:sativacrop_5top")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public Sativacrop5topBlock(GanjacraftModElements instance) {
		super(instance, 181);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("sativacrop_5top"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sativacrop_5top");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("sativacrop_5top");
		}
