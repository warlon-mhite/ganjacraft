...
public class Sativacrop3Block extends GanjacraftModElements.ModElement {
	@ObjectHolder("ganjacraft:sativacrop_3")
	public static final Block block = null;
	@ObjectHolder("ganjacraft:sativacrop_3")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public Sativacrop3Block(GanjacraftModElements instance) {
		super(instance, 177);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("sativacrop_3"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("sativacrop_3");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Sativa stage 3");
		}
