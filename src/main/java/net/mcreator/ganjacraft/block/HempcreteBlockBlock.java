...
public class HempcreteBlockBlock extends GanjacraftModElements.ModElement {
	@ObjectHolder("ganjacraft:hempcrete_block")
	public static final Block block = null;
	public HempcreteBlockBlock(GanjacraftModElements instance) {
		super(instance, 32);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hempcrete_block");
		}
