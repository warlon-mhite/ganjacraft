...
public class Sativacrop7Block extends GanjacraftModElements.ModElement {
	@ObjectHolder("ganjacraft:sativacrop_7")
	public static final Block block = null;
	@ObjectHolder("ganjacraft:sativacrop_7")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public Sativacrop7Block(GanjacraftModElements instance) {
		super(instance, 185);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("sativacrop_7"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("sativacrop_7");
		}
