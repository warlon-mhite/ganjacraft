...
import net.mcreator.ganjacraft.procedures.WeedOnFireBreak2BottomProcedure;
...
public class Sativacrop6topBlock extends GanjacraftModElements.ModElement {
	@ObjectHolder("ganjacraft:sativacrop_6top")
	public static final Block block = null;
	@ObjectHolder("ganjacraft:sativacrop_6top")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public Sativacrop6topBlock(GanjacraftModElements instance) {
		super(instance, 184);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("sativacrop_6top"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sativacrop_6top");
		}
		...
		public void neighborChanged(BlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			}
			{
				...
				WeedOnFireBreak2BottomProcedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("sativacrop_6top");
		}
