...
import net.mcreator.ganjacraft.procedures.IndicaSpliffEffectProcedure;
...
public class SpliffItem extends GanjacraftModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			double z = entity.getPosZ();
			{
				...
				IndicaSpliffEffectProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
