...
import net.mcreator.ganjacraft.procedures.SativaSpliffEffectProcedure;
...
public class SativaSpliffItem extends GanjacraftModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			double z = entity.getPosZ();
			{
				...
				SativaSpliffEffectProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
