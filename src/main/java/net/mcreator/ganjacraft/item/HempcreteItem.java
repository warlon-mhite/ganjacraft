...
public class HempcreteItem extends GanjacraftModElements.ModElement {
	@ObjectHolder("ganjacraft:hempcrete")
	public static final Item block = null;
	public HempcreteItem(GanjacraftModElements instance) {
		super(instance, 30);
	}
